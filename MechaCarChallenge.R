...
library(tidyverse)
mecha_mpg <- read.csv(file="/Users/nabilaqadir/DataClass/Analysis projects/MechaCar_Statistical_Analysis/MechaCar_mpg.csv", check.names=F,stringsAsFactors = F) 
...
mecha_coil <- read.csv(file="/Users/nabilaqadir/DataClass/Analysis projects/MechaCar_Statistical_Analysis/Suspension_Coil.csv", check.names=F,stringsAsFactors = F) 
